...
[Table("sortie")]
[Index("MissionId", "IsDeleted", Name = "idx_missionid_isdeleted")]
[Index("Id", "IsDeleted", Name = "idx_sortie_id_isdeleted")]
public partial class Sortie
{
    ...
    [Column("pilotAi", TypeName = "INTEGER(11)")]
    public long PilotAi { get; set; }

    [Column("status", TypeName = "INTEGER(11)")]
    public long Status { get; set; }

    [Column("score", TypeName = "INTEGER(11)")]
    public long Score { get; set; }

    [Column("planeStatus", TypeName = "int(11)")]
    public long PlaneStatus { get; set; }
